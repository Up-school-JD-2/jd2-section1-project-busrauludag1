...
1. **src.main.java.org.busra.Movie sınıfı**: Her bir film için bir src.main.java.org.busra.Movie sınıfı oluşturun. Bu sınıf, filmin id'sini, filmin başlığını, yönetmenini, oyuncularını, tarihini, açıklamasını, türünü  içermelidir.
...
3. **src.main.java.org.busra.Movie yöneticisi**:  src.main.java.org.busra.Movie sınıfını kullanarak film eklemek, film silmek, film aramak vb. işlemler yapabilecek bir src.main.java.org.busra.Film Yöneticisi sınıfı oluşturun.
